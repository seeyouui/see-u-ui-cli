...
const code7 = ref('')
const code8 = ref('')
const code9 = ref('1234')
const code10 = ref('5678')
const code11 = ref('')
const code12 = ref('')
const code13 = ref('')
const code14 = ref('')
...
const onComplete1 = (value: string) => {
  console.log('4位验证码输入完成：', value)
}

const onComplete2 = (value: string) => {
  console.log('6位验证码输入完成：', value)
}
</script>
